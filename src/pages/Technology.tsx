...
// Use an existing image that is still present in your project
...
const Technology = () => {
  ...
  const postsToShow =
    filteredPosts.length > 0 ? filteredPosts : techPosts;
      ...
      <main id="main-content" className="container-blog py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Stay ahead of the curve with the latest in technology trends,
